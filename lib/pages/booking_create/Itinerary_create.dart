...
class ItineraryCreatePage extends StatefulWidget {
  static const String routeName = '/itineraryCreate';

  final BookingCreateState state;

  ItineraryCreatePage({Key key, this.state}) : super(key: key);

  @override
  _ItineraryCreatePageState createState() => _ItineraryCreatePageState();
}

class _ItineraryCreatePageState extends State<ItineraryCreatePage> {
  @override
